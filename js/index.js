...
// Task: підвантажити дані на сьогодні і вивести їх на сторінку
...
// або альтернативний запис
promise.then(
  data => console.log('data :>> ', data),
  e => console.log('e :>> ', e)
);

// Task: рандомно виконувати проміс успішно або неуспішно
...
// setTimeout(cb,1000) => delay(1000).then(cb)
...
// Task: промісифікувати функцію завантаження зображень
